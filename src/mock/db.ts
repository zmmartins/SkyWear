...
export const bundleProducts: BundleProduct[] = [
    ...
    { id_bundle: "b_summer", id_prod: "s_tshirt1", is_display: false, position_class: "alt-base-top-l-1" },
    { id_bundle: "b_summer", id_prod: "s_tshirt2", is_display: false, position_class: "alt-base-top-r-1" },
